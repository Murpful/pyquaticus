...
if __name__ == '__main__':
    ...
    reward_config = {'agent_0':rew.control, 'agent_1':rew.control, 'agent_2':rew.control, 'agent_3':None, 'agent_4':None, 'agent_5':None} # Example Reward Config
    ...
    for i in range(8001):
        ...
        if np.mod(i, 10) == 0:
            ...
            chkpt_file = algo.save('./ray_test/control/iter_'+str(i)+'/')
