...
if __name__ == '__main__':
    ...
    reward_config = {'agent_0':rew.controla, 'agent_1':rew.controla, 'agent_2':rew.controla, 'agent_3':None, 'agent_4':None, 'agent_5':None} # Example Reward Config
    ...
    for i in range(8000):
        ...
        if np.mod(i, 5) == 0:
            ...
            chkpt_file = algo.save('./ray_test/controlgpu3/iter_'+str(i)+'/')
